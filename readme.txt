...
The default WordPress behavior is to apply the user locale preference to the back-end only &mdash; this plugin extends the user locale preference to the front-end webpage as well. To exclude the "Select Locale" menu item from the front-end toolbar menu &mdash; and ignore the user locale preference in the front-end webpage &mdash; add the following to your functions.php file:
