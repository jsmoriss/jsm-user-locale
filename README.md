...
<p>Add a "Locale" menu item for users in the WordPress back-end (admin) and front-end toolbar menus.</p>
...
<p>If the Polylang plugin is available, the "Locale" menu will use Polylang language URLs for that locale.</p>
...
<p>To exclude the "Locale" menu item from the front-end toolbar menu, <em>and ignore the user locale (language) preference in the front-end webpage</em>, add the following to your functions.php file:</p>
