...
<p>If you're using the <a href="https://wordpress.org/plugins/wpsso/">WPSSO (WordPress Social Sharing Optimization)</a> plugin, the <a href="https://wordpress.org/plugins/wpsso-user-locale/">WPSSO User Locale Selector (WPSSO UL)</a> extension offers the same functionality, with the addition of a settings page to modify the menu icon, menu title, and enable/disable the user locale menu on the front-end.</p>
