...
<p><strong>Perfect for translators or anyone who needs to switch languages quickly and easily</strong> &mdash; allows users to change their preferred locale / language setting right from the toolbar menu instead of having to update their WordPress user profile page.</p>
